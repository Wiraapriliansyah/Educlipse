...
<head>
	...
	<title>Tentang Developer - Educlipse</title>
	<!-- General CSS Files -->
			...
			<div class="main-content">
				<section class="section">
					<div class="section-header">
						<h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Tentang Project Educlipse </h1>
					</div>
					<div class="">
					</div>
					<br>
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Tentang Educlipse</h2>
								<hr>
								<p class="card-text">Educlipse, sebuah platform edukasi open-source yang dikembangkan oleh Wira Apriliansyah Saputra, <br> menawarkan lingkungan belajar yang lengkap dengan video, materi, dan sistem ujian yang tersedia secara gratis. <br> Dengan tujuan untuk mendukung proses belajar mengajar yang fleksibel, Educlipse memungkinkan siswa dan guru untuk belajar dan mengajar kapan saja dan di mana saja. </p>
							</div>
						</div>
					</div>
				</section>
