					...
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								...
								<hr>
								<p class="card-text">Educlipse, sebuah platform edukasi open-source yang dikembangkan oleh Wira Apriliansyah Saputra,
								menawarkan lingkungan belajar yang lengkap dengan video, materi, dan sistem ujian yang tersedia secara gratis.
								Dengan tujuan untuk mendukung proses belajar mengajar yang fleksibel, Educlipse memungkinkan siswa dan guru untuk belajar dan mengajar kapan saja dan di mana saja. </p>
							</div>
						</div>
					</div>
					<br>
