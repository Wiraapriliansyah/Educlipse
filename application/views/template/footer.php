...
Educlipse adalah Web edukasi yang dilengkapi video, materi dan sistem ujian
yang tersedia secara gratis. Educlipse dibuat ditujukan agar para siswa dan
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?= base_url('welcome/tentang') ?>">Tentang Educlipse</a></li>
                        <li><a href="<?= base_url('welcome/materi') ?>">Materi Educlipse</a></li>
                        <li><a href="<?= base_url('welcome/kontak') ?>">Kontak Educlipse</a></li>
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li>Sebagai mahasiswa Akuntansi di Universitas Diponegoro, saya memiliki minat yang kuat dalam memanfaatkan teknologi untuk meningkatkan efisiensi dan efektivitas dalam pendidikan. Dengan latar belakang akademik saya dalam bidang akuntansi, saya memahami pentingnya detail dan organisasi dalam pengelolaan informasi. Keterampilan ini, ditambah dengan minat saya dalam teknologi dan pemrograman, telah mendorong saya untuk menciptakan Educlipse, sebuah platform eLearning yang dirancang untuk membantu siswa dan guru agar dapat terus belajar dan mengajar kapan saja dan di mana saja.</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang Educlipse</h4>
                <p>
                Educlipse, sebuah platform edukasi open-source yang dikembangkan oleh Wira Apriliansyah Saputra, menawarkan lingkungan belajar yang lengkap dengan video, materi, dan sistem ujian yang tersedia secara gratis. Dengan tujuan untuk mendukung proses belajar mengajar yang fleksibel, Educlipse memungkinkan siswa dan guru untuk belajar dan mengajar kapan saja dan di mana saja.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                <a href="https://colorlib.com" target="_blank">Colorlib</a> <br> Educlipse is made with <span class="text-danger"> &#10084;</span> by <a href="https://github.com/Wiraapriliansyah">Wira Apriliansyah Saputra </a> with MIT License
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
