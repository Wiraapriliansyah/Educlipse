...
<head>
    ...
    <meta content="Educlipse dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja." name="Description" />
    <meta content="Educlipse, E-learning, Open Source, Wira Apriliansyah Saputra, github, programmer indonesia" name="keywords" />
    <link rel="icon" href="<?= base_url('assets/') ?>img/faviconedu.png" type="image/png">
    <title>Educlipse - Transformasi Dunia Pendidikan!</title>
    <!-- Bootstrap CSS -->
